...
void zona1(){
  ...
  if (sms.SendSMS("086988524038","Zona 01 Extraviada!!!"))
  Serial.println("nSMS sent OK");
...
void zona2(){
  ...
  digitalWrite(red, HIGH);
  if (sms.SendSMS("086988524038","Zona 02 Extraviada!!!"))
  Serial.println("nSMS sent OK");
}
//ZONA 03
void zona3(){
  ...
  digitalWrite(red, HIGH);
  if (sms.SendSMS("086988524038","Zona 03 Extraviada!!!"))
  Serial.println("nSMS sent OK");
}
//ZONA 04
void zona4(){
  ...
  digitalWrite(red, HIGH);
  if (sms.SendSMS("086988524038","Zona 4 Extraviada!!!"))
  Serial.println("nSMS sent OK");
}
...
// DECLARAR AS VARIAVEIS COMO ENTRADA OU SAIDA
  ...
  Serial.println("Testando GSM shield...");
     ...
     if(started) 
     {
       //Envia um SMS para o numero selecionado
       //Formato sms.SendSMS(<numero>,<mensagem>)
       if (sms.SendSMS("086988524038","OK!!!"))
       Serial.println("nSMS sent OK");
     }
